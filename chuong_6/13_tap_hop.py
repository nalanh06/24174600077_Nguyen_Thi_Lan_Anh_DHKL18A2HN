...
#- Không có sắp xếp, không có thứ tụ
...
#Kiểm tra tập A có phải tập hợp con của tập hợp B hay không?
tap_hop_a.issubset(tap_hop_b) #=> trả về kiểu dữ liệu boolean
tap_hop_a < tap_hop_b
tap_hop_a <= tap_hop_b

# Kiểm tra tập hợp A có phải tập cha của tậpB hay không
